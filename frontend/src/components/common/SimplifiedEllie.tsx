...
interface SimplifiedEllieProps {
  mood?: 'idle' | 'happy' | 'waving' | 'sleeping' | 'curious' | 'walking' | 'excited';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Body */}
        <ellipse cx="50" cy="60" rx="23" ry="25" fill="url(#simpleBodyGradient)" filter="url(#simpleShadow)" />

        {/* Head */}
        <circle cx="50" cy="35" r="20" fill="#ffffff" filter="url(#simpleShadow)" />

        {/* Ears */}
        <ellipse cx="35" cy="25" rx="10" ry="12" fill="#ffffff" filter="url(#simpleShadow)" />
        <ellipse cx="65" cy="25" rx="10" ry="12" fill="#ffffff" filter="url(#simpleShadow)" />
        ...
        {mood !== 'sleeping' ? (
          ...
          <>
            <path d="M 39 35 Q 42 37 45 35" stroke="#1f2937" strokeWidth="1.5" fill="none" />
            <path d="M 55 35 Q 58 37 61 35" stroke="#1f2937" strokeWidth="1.5" fill="none" />
          </>
        )}
        ...
        {/* Mouth (subtle) */}
        <path d="M 46 43 Q 50 45 54 43" stroke="#d4d4d8" strokeWidth="1" fill="none" strokeLinecap="round" />

        {/* Arms */}
        {mood === 'waving' || mood === 'excited' ? (
          <>
            {/* Waving arm */}
            <ellipse cx="30" cy="55" rx="7" ry="10" fill="#ffffff" transform="rotate(-40 30 55)" filter="url(#simpleShadow)">
              <animateTransform
            ...
            <ellipse cx="70" cy="58" rx="7" ry="10" fill="#ffffff" transform="rotate(20 70 58)" filter="url(#simpleShadow)" />
          </>
        ) : (
          <>
            <ellipse cx="32" cy="58" rx="7" ry="10" fill="#ffffff" transform="rotate(-20 32 58)" filter="url(#simpleShadow)" />
            <ellipse cx="68" cy="58" rx="7" ry="10" fill="#ffffff" transform="rotate(20 68 58)" filter="url(#simpleShadow)" />
          </>
        )}

        {/* Feet with paw pads */}
        <ellipse cx="40" cy="75" rx="8" ry="6" fill="#ffffff" filter="url(#simpleShadow)" />
        <ellipse cx="60" cy="75" rx="8" ry="6" fill="#ffffff" filter="url(#simpleShadow)" />
