...
import { Search, Filter, X, Calendar, Tag, FileText, Heart } from 'lucide-react';
    ...
    <div className="bg-surface rounded-lg p-4 mb-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-20 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
        />
