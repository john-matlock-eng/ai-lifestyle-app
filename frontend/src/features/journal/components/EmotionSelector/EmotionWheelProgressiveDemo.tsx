    ...
    <div className="max-w-4xl mx-auto p-8 space-y-6">
      <div className="bg-surface rounded-lg p-6 shadow-lg">
        <h1 className="text-2xl font-bold mb-4">
          Emotion Wheel - Progressive Reveal Demo
        </h1>
        ...
        {progressiveReveal && (
          <div className="mb-4 p-4 bg-accent/10 rounded-lg">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm">
              <li>
                Select a <strong>core emotion</strong> (center of wheel) to
                begin
              </li>
              <li>Secondary emotions for that core will appear - select one</li>
              <li>
                Tertiary emotions for that secondary will appear - select one or
                more
              </li>
              <li>
                Click "Complete Selection" or "Add Another Emotion" to continue
              </li>
            </ol>
          </div>
        )}
