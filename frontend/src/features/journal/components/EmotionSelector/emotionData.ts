...
export const emotions: Emotion[] = [
  ...
  { id: 'let-down', label: 'Let down', color: emotionColors.angryLight, parent: 'angry', level: 'secondary' },
  ...
  { id: 'disappointed', label: 'Disappointed', color: emotionColors.sadDark, parent: 'hurt', level: 'tertiary' },
  ...
  { id: 'betrayed', label: 'Betrayed', color: emotionColors.angryDark, parent: 'let-down', level: 'tertiary' },
  { id: 'resentful', label: 'Resentful', color: emotionColors.angryDark, parent: 'let-down', level: 'tertiary' },
  ...
  { id: 'overwhelmed-bad', label: 'Overwhelmed', color: emotionColors.badDark, parent: 'stressed', level: 'tertiary' },
  { id: 'out-of-control', label: 'Out of control', color: emotionColors.badDark, parent: 'stressed', level: 'tertiary' },
