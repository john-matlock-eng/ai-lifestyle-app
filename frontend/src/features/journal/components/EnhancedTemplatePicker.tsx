...
const templateCategories = [
  {
    name: 'Daily',
    templates: [JournalTemplate.DAILY_REFLECTION, JournalTemplate.MOOD_TRACKER, JournalTemplate.HABIT_TRACKER]
  },
  {
    name: 'Goals & Progress',
  ...
  return (
    <div className="enhanced-template-picker">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-theme mb-2">Choose a Journal Template</h2>
        <p className="text-muted">Select a template to guide your journaling experience</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {/* Blank Template Card */}
        {showBlank && (selectedCategory === null || selectedCategory === 'Creative') && (
          <div
          ...
          >
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-theme">Blank Journal</h3>
                <p className="text-sm text-muted mt-1">Start with a clean slate</p>
              </div>
            </div>
            
            <div className="space-y-3">
              <p className="text-sm text-muted">
                No structure or prompts - just you and your thoughts. Perfect for free writing.
              </p>
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-4">
                  <div 
                    ...
                    style={{ 
                      backgroundColor: hoveredTemplate === templateId ? `${template.color}20` : 'rgb(var(--surface-muted))',
                      color: hoveredTemplate === templateId ? template.color : 'rgb(var(--muted))'
                    }}
                  >
                    {getIconComponent(templateId)}
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-theme">{template.name}</h3>
                ...
                <div className="space-y-3">
                  ...
                  {template.extractors?.tags && (
                    <div className="flex flex-wrap gap-1">
                      {template.extractors.tags({}).slice(0, 3).map(tag => (
