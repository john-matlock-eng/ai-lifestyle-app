...
const RichTextEditorTestPage: React.FC = () => {
  ...
  const [content2, setContent2] = useState('# Test with menus enabled\n\nTry selecting text to see the bubble menu.');
  const [content3] = useState('## Readonly Example\n\nThis editor is in read-only mode.');
  
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <div>
          <h1 className="text-2xl font-bold mb-4">Rich Text Editor Test Page</h1>
        ...
        <div className="space-y-4">
          <div>
            <h2 className="text-lg font-semibold mb-2">Test 1: Default Settings (Recommended)</h2>
            <p className="text-sm text-muted mb-4">
              This uses the default settings with menus disabled. This is the safest configuration.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div>
            <h2 className="text-lg font-semibold mb-2">Test 2: With Bubble Menu Enabled</h2>
            <p className="text-sm text-muted mb-4">
              This has the bubble menu enabled. Select some text to see it appear. It should not interfere with typing.
            </p>
          </div>
          <div className="bg-surface rounded-lg p-4">
            <RichTextEditor
        ...
        <div className="space-y-4">
          <div>
            <h2 className="text-lg font-semibold mb-2">Test 3: Read-Only Mode</h2>
            <p className="text-sm text-muted mb-4">
        ...
        <div className="bg-accent/10 border border-accent/30 rounded-lg p-4 mt-8">
          ...
          <ol className="list-decimal list-inside space-y-1 text-sm">
            <li>Try typing in the first editor - it should work without any issues</li>
            <li>Try using the toolbar buttons - they should apply formatting correctly</li>
            <li>In the second editor, select some text to see the bubble menu</li>
            <li>The bubble menu should appear above the selection, not over it</li>
