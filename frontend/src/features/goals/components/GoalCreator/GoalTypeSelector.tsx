        ...
        {goalPatternConfigs.map((config) => {
          ...
          return (
            <button
              ...
              className="group relative bg-[var(--surface)] rounded-xl border-2 border-gray-200 p-6 text-left hover:border-gray-300 hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
