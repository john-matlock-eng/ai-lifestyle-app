  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Icon Sizes */}
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-theme">Icon (Favicon)</h2>
        ...
        {/* Horizontal Logo */}
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-theme">Horizontal Logo</h2>
        ...
        {/* Usage Examples */}
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-theme">Usage Examples</h2>
          ...
          <div className="bg-surface rounded-lg p-6 mb-6">
            <header className="flex items-center justify-between">
              ...
              <nav className="flex gap-6">
                <a href="#" className="text-theme hover:text-accent">Dashboard</a>
                <a href="#" className="text-theme hover:text-accent">Goals</a>
                <a href="#" className="text-theme hover:text-accent">Journal</a>
              </nav>
            </header>
            <p className="mt-4 text-sm text-muted">Header with horizontal logo</p>
          </div>
          ...
          <div className="bg-surface rounded-lg p-6 mb-6">
            <div className="flex items-center gap-4">
              <EllieLogo variant="icon" size="lg" />
              <div>
                <h3 className="text-lg font-semibold text-theme">AI Lifestyle App</h3>
                <p className="text-sm text-muted">Your wellness journey starts here</p>
              </div>
            </div>
          ...
          <div className="bg-surface rounded-lg p-6 flex flex-col items-center justify-center h-64">
            ...
            <p className="mt-4 text-theme">Loading your wellness dashboard...</p>
            <p className="mt-4 text-sm text-muted">Loading screen with animated sparkle</p>
          </div>
        </section>
