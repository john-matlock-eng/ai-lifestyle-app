...
import type { Goal, GoalPattern } from "../features/goals";
...
export const ComponentShowcase: React.FC = () => {
  ...
  const [selectedGoalPattern, setSelectedGoalPattern] = useState<
          ...
          <div className="space-y-8">
            <div className="bg-surface rounded-lg shadow-sm border border-[color:var(--surface-muted)] p-6">
              ...
              <p className="text-muted mb-6">
                This is a demonstration of all the UI components built for the
                AI Lifestyle App. Navigate through the sections above to explore
        ...
        {activeSection === "journal" && (
          <div className="space-y-8">
            ...
            <p className="text-muted">
              Journal components have been migrated to the enhanced journal
              system. View them in the Journal page.
            </p>
          </div>
        )}
      </main>
