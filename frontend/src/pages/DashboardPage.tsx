...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div>
        ...
        <div className="bg-surface overflow-hidden shadow-md rounded-lg hover:shadow-lg transition-all hover-lift border border-surface-muted">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <svg
                  className="h-6 w-6 text-warning-theme"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div className="bg-surface overflow-hidden shadow-md rounded-lg hover:shadow-lg transition-all hover-lift border border-surface-muted">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <svg
                  className="h-6 w-6 text-error-theme"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div className="bg-surface overflow-hidden shadow-md rounded-lg hover:shadow-lg transition-all hover-lift border border-surface-muted">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <svg
                  className="h-6 w-6 text-success-theme"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
      ...
      {/* Quick Actions */}
      <div className="mt-8">
        <h3 className="text-lg leading-6 font-medium text-theme">
          Quick Actions
        </h3>
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <button className="relative rounded-lg border border-surface-muted bg-surface px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-accent hover:shadow-md focus:outline-none focus:shadow-focus transition-all hover-lift">
            <div className="flex-shrink-0">
              <svg
                className="h-10 w-10 text-warning-theme"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <button className="relative rounded-lg border border-surface-muted bg-surface px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-accent hover:shadow-md focus:outline-none focus:shadow-focus transition-all hover-lift">
            <div className="flex-shrink-0">
              <svg
                className="h-10 w-10 text-success-theme"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
      ...
      <div className="mt-8 bg-surface shadow-md rounded-lg border border-surface-muted">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-5 space-y-3">
            <div className="flex items-center">
              <svg
                className="h-5 w-5 text-success-theme mr-2"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
            ...
            <div className="flex items-center">
              <svg
                className={`h-5 w-5 ${user?.mfaEnabled ? "text-success-theme" : "text-text-disabled"} mr-2`}
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
