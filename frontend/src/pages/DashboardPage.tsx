...
const DashboardPage: React.FC = () => {
  ...
  const recentActivities = [
    { type: "meal", title: "Healthy Breakfast", time: "2 hours ago", icon: "🥗" },
    { type: "workout", title: "Morning Run - 5km", time: "5 hours ago", icon: "🏃" },
    { type: "journal", title: "Daily Reflection", time: "Yesterday", icon: "📔" },
    { type: "goal", title: "Completed: Drink 8 glasses of water", time: "Yesterday", icon: "✅" },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-gradient-to-tl from-[var(--success)] to-[var(--accent)] opacity-10 blur-3xl animate-float-orb" style={{ animationDelay: '10s' }} />
      </div>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-[var(--text)] mb-4">Quick Actions</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {quickActions.map((action, index) => (
            ...
            >
              <div className="relative z-10">
                <span className="text-4xl mb-3 block icon-bounce">{action.icon}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--surface)] rounded-xl border border-[var(--surface-muted)] p-6">
          <h2 className="text-xl font-bold text-[var(--text)] mb-4">Recent Activities</h2>
        ...
        {/* Progress Overview */}
        <div className="bg-[var(--surface)] rounded-xl border border-[var(--surface-muted)] p-6">
          <h2 className="text-xl font-bold text-[var(--text)] mb-4">Weekly Progress</h2>
          
          {/* Progress bars */}
          <div className="space-y-4">
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm font-medium text-[var(--text)]">Nutrition Goals</span>
                <span className="text-sm text-[var(--text-muted)]">75%</span>
              </div>
              <div className="h-3 bg-[var(--surface-hover)] rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 animate-progress-fill" style={{ width: '75%' }} />
              </div>
            </div>
            
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm font-medium text-[var(--text)]">Exercise Minutes</span>
                <span className="text-sm text-[var(--text-muted)]">120/150</span>
              </div>
              <div className="h-3 bg-[var(--surface-hover)] rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full transition-all duration-500 animate-progress-fill" style={{ width: '80%', animationDelay: '0.2s' }} />
              </div>
            </div>
            
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm font-medium text-[var(--text)]">Sleep Quality</span>
                <span className="text-sm text-[var(--text-muted)]">92%</span>
              </div>
              <div className="h-3 bg-[var(--surface-hover)] rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-purple-500 to-pink-500 rounded-full transition-all duration-500 animate-progress-fill" style={{ width: '92%', animationDelay: '0.4s' }} />
              </div>
            </div>
            
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-sm font-medium text-[var(--text)]">Hydration</span>
                <span className="text-sm text-[var(--text-muted)]">6/8 glasses</span>
              </div>
              <div className="h-3 bg-[var(--surface-hover)] rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-orange-500 to-yellow-500 rounded-full transition-all duration-500 animate-progress-fill" style={{ width: '75%', animationDelay: '0.6s' }} />
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 rounded-lg bg-gradient-to-r from-[var(--accent)]/10 to-[var(--success)]/10 border border-[var(--accent)]/20">
            <p className="text-sm text-[var(--text)]">
              <span className="font-semibold">Great progress!</span> You're on track to meet 3 out of 4 weekly goals. Keep it up! 🎯
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 relative rounded-xl overflow-hidden">
        ...
        <div className="relative bg-[var(--surface)] m-[1px] rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-[var(--text)]">Account Security</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-[var(--text)]">Email Verified</p>
            ...
            <div className="flex items-center gap-3">
              <div className={clsx(
                "p-2 rounded-lg",
                isEncryptionEnabled ? "bg-[var(--success)]/10" : "bg-[var(--warning)]/10"
              )}>
                <svg className={clsx(
                  "w-5 h-5",
                  isEncryptionEnabled ? "text-[var(--success)]" : "text-[var(--warning)]"
                )} fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
              </div>
              <div>
                <p className="text-sm font-medium text-[var(--text)]">Encryption</p>
            ...
            <div className="flex items-center gap-3">
              <div className={clsx(
                "p-2 rounded-lg",
                user?.mfaEnabled ? "bg-[var(--success)]/10" : "bg-[var(--surface-hover)]"
              )}>
                <svg className={clsx(
                  "w-5 h-5",
                  user?.mfaEnabled ? "text-[var(--success)]" : "text-[var(--text-muted)]"
                )} fill="currentColor" viewBox="0 0 20 20">
