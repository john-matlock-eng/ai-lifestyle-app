...
export interface paths {
    ...
    "/goals/{goalId}": {
        ...
        head?: never;
        /**
         * Update goal module flag
         * @description Partially update goal to link with a module
         */
        patch: operations["patchGoalModule"];
        trace?: never;
    };
    ...
    "/journal/stats": {
         ...
         * @description Returns journaling metrics and progress on linked goals
         */
...
export interface operations {
    ...
    listGoals: {
        parameters: {
            query?: {
                ...
                category?: string[];
                /** @description Filter by linked module */
                module?: "journal";
                page?: number;
                limit?: number;
    ...
    patchGoalModule: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PatchGoalModuleRequest"];
            };
        };
        responses: {
            /** @description Goal updated successfully */
    ...
    getJournalStats: {
        ...
        requestBody?: never;
        responses: {
            /** @description Journal stats retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
