...
export interface paths {
    ...
    "/encryption/user/{userId}": {
         ...
         */
        get: operations["getUserEncryption"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/encryption/check/{userId}": {
         ...
         */
        get: operations["checkUserEncryption"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/encryption/setup": {
         ...
         */
        post: operations["setupEncryption"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CreateJournalEntryRequest: {
            ...
            content: string;
            /** @enum {string} */
            template: "blank" | "daily-reflection" | "gratitude" | "goals-progress" | "emotional-checkin" | "dream-journal" | "creative-writing";
            tags?: string[];
            mood?: string;
        ...
        JournalEntry: {
            ...
            shareAccess?: components["schemas"]["ShareAccess"];
        };
        JournalGoalProgress: {
            /** Format: uuid */
            goalId: string;
        ...
        SharedJournalItem: {
            ...
            shareInfo: components["schemas"]["ShareInfo"];
        ...
        SharedJournalsResponse: {
            entries: (components["schemas"]["JournalEntry"] | components["schemas"]["SharedJournalItem"])[];
            total: number;
            page: number;
            limit: number;
            hasMore: boolean;
...
export interface operations {
    ...
    listJournalEntries: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SharedJournalsResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    listShares: {
        parameters: {
            query?: {
                itemType?: "journal" | "goal";
                direction?: "created" | "received" | "all";
            };
            header?: never;
            path?: never;
            cookie?: never;
    ...
    createAIShare: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["AIShareResponse"];
                };
            };
    ...
    getUserByEmail: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UserBasicInfo"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    getUserEncryption: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UserEncryptionInfo"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    checkUserEncryption: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EncryptionCheckResponse"];
                };
            };
            /** @description Unauthorized */
            401: {
