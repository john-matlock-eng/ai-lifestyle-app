...
export interface paths {
    ...
    "/ai/reflect": {
         ...
         * @description Generate a reflection response for a journal section
         */
        post: operations["reflectEntrySection"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/ai/analyze-mood": {
        ...
        put?: never;
        /**
         * Analyze mood of entry
         * @description Classify emotions in a journal entry
         */
        post: operations["analyzeMood"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/ai/summarize-week": {
         ...
         * @description Generate a weekly digest summary
         */
        post: operations["summarizeWeek"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        JournalAnalyzeMoodRequest: {
            entryId: string;
            markdown: string;
        };
        JournalAnalyzeMoodResponse: {
            emotions: {
                [key: string]: number;
            };
        };
        ...
        JournalSummarizeWeekRequest: {
            userId: string;
            entries: components["schemas"]["JournalEntry"][];
        };
        JournalSummarizeWeekResponse: {
            summary: string;
            highlights: string[];
        };
    };
...
export interface operations {
    ...
    reflectEntrySection: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["JournalReflectRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["JournalReflectResponse"];
                };
            };
    ...
    analyzeMood: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["JournalAnalyzeMoodRequest"];
            };
        };
        responses: {
            /** @description Mood analyzed */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["JournalAnalyzeMoodResponse"];
                };
            };
            /** @description Invalid request */
            400: {
    ...
    summarizeWeek: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["JournalSummarizeWeekRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["JournalSummarizeWeekResponse"];
                };
            };
            /** @description Invalid request */
            400: {
