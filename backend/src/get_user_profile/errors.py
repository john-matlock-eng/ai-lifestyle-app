"""
Custom exceptions for get user profile service.
"""
...
class UnauthorizedError(ProfileError):
    ...
    def __init__(self, message: str = "Invalid or missing authentication token", details: Optional[Dict[str, Any]] = None):
