...
def login_service(mock_user_repository, mock_cognito_client):
    ...
    return LoginService(user_repository=mock_user_repository, cognito_client=mock_cognito_client)
...
class TestLoginService:
    ...
    def test_successful_login_without_mfa(
        ...
        mock_cognito_client.get_user_attributes.return_value = {"email_verified": "true"}
    ...
    def test_login_with_mfa_required(self, login_service, login_request, mock_cognito_client):
        ...
        mock_cognito_client.authenticate_user.side_effect = MfaRequiredError(
            session_token="temp-session-id", challenge_name="SOFTWARE_TOKEN_MFA"
        )
    ...
    def test_invalid_credentials(self, login_service, login_request, mock_cognito_client):
    ...
    def test_unexpected_error_handling(self, login_service, login_request, mock_cognito_client):
