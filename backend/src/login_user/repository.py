...
class UserRepository:
    ...
    def get_user_by_email(self, email: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Error querying user by email", extra={"email": email, "error": str(e)})
            raise
    ...
    def get_user_by_id(self, user_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Error getting user by ID", extra={"userId": user_id, "error": str(e)})
            raise
    ...
    def update_last_login(self, user_id: str, login_timestamp: datetime) -> None:
        ...
        try:
            self.table.update_item(
                ...
                ExpressionAttributeValues={":timestamp": login_timestamp.isoformat()},
            )

            logger.info(
                "Updated last login timestamp",
                extra={"userId": user_id, "timestamp": login_timestamp.isoformat()},
            )

        except ClientError as e:
            logger.error("Error updating last login", extra={"userId": user_id, "error": str(e)})
    ...
    def record_login_attempt(
        ...
        try:
            ...
            logger.error("Error recording login attempt", extra={"email": email, "error": str(e)})
