...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            metrics.add_metric(name="UnauthorizedEncryptionDeletionAttempts", unit=MetricUnit.Count, value=1)
        ...
        try:
            ...
            metrics.add_metric(name="UserProfileEncryptionRemovalFailures", unit=MetricUnit.Count, value=1)
