...
from journal_common import CreateJournalEntryRequest, GoalProgress, JournalEntry, JournalTemplate
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            metrics.add_metric(
                name="UnauthorizedJournalCreationAttempts", unit=MetricUnit.Count, value=1
            )
        ...
        try:
            ...
            metrics.add_metric(
                name="InvalidJournalCreationRequests", unit=MetricUnit.Count, value=1
            )
        ...
        try:
            ...
            metrics.add_metric(
                name="JournalEntryValidationFailures", unit=MetricUnit.Count, value=1
            )
        ...
        try:
            ...
            metrics.add_metric(
                name=f"JournalTemplate_{template_value}", unit=MetricUnit.Count, value=1
            )
