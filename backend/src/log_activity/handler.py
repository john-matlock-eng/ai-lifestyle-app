...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            metrics.add_metric(
                name="UnauthorizedActivityLogAttempts", unit=MetricUnit.Count, value=1
            )
            ...
            if hasattr(e, "errors"):
                for error in e.errors():
                    ...
                    validation_errors.append(
                        {"field": ".".join(field_parts), "message": error["msg"]}
                    )
            else:
        ...
        metrics.add_metric(
            name=f"ActivityType_{request_data.activity_type}", unit=MetricUnit.Count, value=1
        )
