...
from patch_goal_module.handler import lambda_handler as patch_goal_module_handler
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    routes = {
        ...
        "PATCH /goals/{goalId}": patch_goal_module_handler,
        ...
        if len(path_parts) >= 3 and path_parts[1] == 'goals':
            ...
            if len(path_parts) == 3:
                ...
                if http_method == 'GET':
                    ...
                    handler = patch_goal_module_handler
