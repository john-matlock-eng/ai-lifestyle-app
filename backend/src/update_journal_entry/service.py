...
from journal_common import JournalEntry, JournalRepository, UpdateJournalEntryRequest
...
class UpdateJournalEntryService:
    ...
    def update_entry(
        self, user_id: str, entry_id: str, request: UpdateJournalEntryRequest
    ) -> JournalEntry:
        """
        ...
        try:
            ...
            if "word_count" in updates:
                self._update_word_count_stats(
                    user_id, existing_entry.word_count, updates["word_count"]
                )
