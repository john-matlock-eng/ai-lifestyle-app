...
class EncryptionRepository:
    ...
    def delete_encryption_keys(self, user_id: str) -> None:
        ...
        Args:
            user_id: User ID
        """
        self.table.delete_item(Key={"pk": f"USER#{user_id}", "sk": "ENCRYPTION"})
    ...
    def _get_ai_public_key(self) -> str:
        ...
        response = ssm.get_parameter(
            Name="/ai-lifestyle-app/ai-service/public-key", WithDecryption=False
        )
    ...
    def get_share(self, share_id: str, recipient_id: str) -> Optional[Share]:
        ...
        response = self.table.get_item(
            Key={"pk": f"USER#{recipient_id}", "sk": f"SHARE#{share_id}"}
        )
    ...
    def get_shares_for_recipient(
        self, recipient_id: str, item_type: Optional[str] = None, active_only: bool = True
    ) -> List[Share]:
        """
    ...
    def get_shares_by_owner(
        self, owner_id: str, item_type: Optional[str] = None, active_only: bool = True
    ) -> List[Share]:
        """
    ...
    def _item_to_share(self, item: Dict[str, Any]) -> Share:
        ...
        return Share(
            ...
            accessed_at=(
                datetime.fromisoformat(item["AccessedAt"]) if item.get("AccessedAt") else None
            ),
