"""Lambda handler for POST /ai/summarize-week"""
import json
...
from journal_ai.models import SummarizeWeekRequest, SummarizeWeekResponse
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    result: SummarizeWeekResponse = service.summarize_week(req)
    metrics.add_metric(name="JournalSummarizeWeek", unit=MetricUnit.Count, value=1)
    return {
        "statusCode": 200,
        "headers": {"Content-Type": "application/json", "X-Request-ID": request_id},
