...
from .errors import CognitoError, InvalidMFACodeError, InvalidSessionError, TooManyAttemptsError
...
class CognitoMFAAuthClient:
    ...
    def respond_to_mfa_challenge(
        self, session_token: str, mfa_code: str, username: Optional[str] = None
    ) -> Dict[str, Any]:
        """
