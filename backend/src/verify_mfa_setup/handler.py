...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            metrics.add_metric(name="UnauthorizedMFAVerificationAttempts", unit=MetricUnit.Count, value=1)
        ...
        try:
            ...
            metrics.add_metric(name="InvalidMFAVerificationRequests", unit=MetricUnit.Count, value=1)
