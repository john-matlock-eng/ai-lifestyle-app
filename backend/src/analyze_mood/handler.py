"""Lambda handler for POST /ai/analyze-mood"""
import json
...
from journal_ai.models import AnalyzeMoodRequest, AnalyzeMoodResponse
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    result: AnalyzeMoodResponse = service.analyze_mood(req)
    metrics.add_metric(name="JournalAnalyzeMood", unit=MetricUnit.Count, value=1)
    return {
        "statusCode": 200,
        "headers": {"Content-Type": "application/json", "X-Request-ID": request_id},
