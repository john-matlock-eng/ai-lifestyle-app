...
from goals_common import GoalNotFoundError, GoalPermissionError, GoalError
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            metrics.add_metric(name="UnauthorizedProgressAccessAttempts", unit=MetricUnit.Count, value=1)
