...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            metrics.add_metric(name="UnauthorizedActivityListAttempts", unit=MetricUnit.Count, value=1)
        ...
        metrics.add_metric(name="ActivitiesReturned", unit=MetricUnit.Count, value=len(response['activities']))
