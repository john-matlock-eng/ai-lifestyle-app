...
class GetJournalEntryService:
    ...
    def get_entry(self, user_id: str, entry_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not share:
                logger.warning(f"User {user_id} attempted to access journal {entry_id} - not found or not shared")
            ...
            logger.info(f"User {user_id} accessing shared journal {entry_id} via share {share.share_id}")
