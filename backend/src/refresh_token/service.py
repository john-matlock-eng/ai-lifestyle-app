...
class TokenRefreshService:
    ...
    def refresh_token(self, request: RefreshTokenRequest) -> RefreshTokenResponse:
        ...
        logger.info(
            ...
            extra={"has_refresh_token": bool(request.refreshToken)},
        )
        ...
        try:
            ...
            logger.info(
                ...
                extra={"expires_in": response.expiresIn, "token_type": response.tokenType},
            )
    ...
    def validate_new_token(self, access_token: str) -> bool:
        ...
        try:
            ...
            logger.error("Failed to validate new access token", extra={"error": str(e)})
            return False
