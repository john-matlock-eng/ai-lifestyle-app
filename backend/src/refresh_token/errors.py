...
class InvalidTokenError(RefreshError):
    ...
    def __init__(
        self, message: str = "Invalid refresh token", details: Optional[Dict[str, Any]] = None
    ):
...
class ExpiredTokenError(RefreshError):
    ...
    def __init__(
        self, message: str = "Refresh token has expired", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message, details)
...
class ConfigurationError(RefreshError):
    ...
    def __init__(
        self, message: str = "Service configuration error", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(message, details)
