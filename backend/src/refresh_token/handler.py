...
from .errors import ExpiredTokenError, InvalidTokenError, RefreshError, RevokedTokenError
from .models import (
    ErrorResponse,
    RefreshTokenRequest,
...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    ...
    try:
        ...
        error_response = ErrorResponse(
            error="INVALID_TOKEN", message=e.message, request_id=request_id
        )
        ...
        error_response = ErrorResponse(
            error="TOKEN_EXPIRED", message=e.message, request_id=request_id
        )
        ...
        error_response = ErrorResponse(
            error="TOKEN_REVOKED", message=e.message, request_id=request_id
        )
        ...
        error_response = ErrorResponse(
            error="REFRESH_ERROR", message=e.message, request_id=request_id
        )
