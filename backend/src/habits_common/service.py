...
from .errors import ValidationError, HabitNotFoundError
...
class HabitService:
    ...
    def update_habit(self, user_id: str, habit_id: str, 
                    request: UpdateHabitRequest) -> HabitResponse:
        """Update a habit."""
    ...
    def check_in_habit(self, user_id: str, habit_id: str, 
                      request: HabitCheckInRequest) -> HabitCheckInResponse:
        ...
        logger.info(f"Checking in habit {habit_id} for user {user_id} - completed: {request.completed}")
