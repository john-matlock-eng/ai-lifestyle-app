...
from refresh_token.models import RefreshTokenResponse, CognitoTokenResponse
...
class TestRefreshTokenHandler:
    ...
    def test_successful_token_refresh(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
    ...
    @patch('refresh_token.handler.TokenRefreshService')
    @patch('refresh_token.handler.CognitoClient')
    def test_invalid_token_error(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
    ...
    @patch('refresh_token.handler.TokenRefreshService')
    @patch('refresh_token.handler.CognitoClient')
    def test_expired_token_error(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
        """Test expired token error handling."""
        # Setup mocks
        mock_service = Mock()
        mock_service_class.return_value = mock_service
        mock_service.refresh_token.side_effect = ExpiredTokenError(
    ...
    @patch('refresh_token.handler.TokenRefreshService')
    @patch('refresh_token.handler.CognitoClient')
    def test_revoked_token_error(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
        """Test revoked token error handling."""
        # Setup mocks
        mock_service = Mock()
        mock_service_class.return_value = mock_service
        mock_service.refresh_token.side_effect = RevokedTokenError(
    ...
    @patch('refresh_token.handler.TokenRefreshService')
    @patch('refresh_token.handler.CognitoClient')
    def test_generic_refresh_error(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
        """Test generic refresh error handling."""
        # Setup mocks
        mock_service = Mock()
        mock_service_class.return_value = mock_service
        mock_service.refresh_token.side_effect = RefreshError(
    ...
    @patch('refresh_token.handler.TokenRefreshService')
    @patch('refresh_token.handler.CognitoClient')
    def test_unexpected_error(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
    ...
    @patch('refresh_token.handler.TokenRefreshService')
    @patch('refresh_token.handler.CognitoClient')
    def test_metrics_logging(self, mock_cognito_client_class, mock_service_class, valid_event, lambda_context):
