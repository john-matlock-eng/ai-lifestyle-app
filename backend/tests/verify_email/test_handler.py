...
class TestEmailVerificationHandler:
    ...
    def test_successful_verification(self, mock_service_class, valid_event, lambda_context):
        ...
        # Arrange
        mock_service = Mock()
        mock_service.verify_email_with_token.return_value = "Email successfully verified. You can now access all features of the app."
        ...
        assert body['message'] == "Email successfully verified. You can now access all features of the app."
    ...
    def test_invalid_token(self, mock_service_class, valid_event, lambda_context):
        ...
        # Arrange
        mock_service = Mock()
        mock_service.verify_email_with_token.side_effect = InvalidTokenError("Invalid verification code")
        mock_service_class.return_value = mock_service
    ...
    def test_general_verification_error(self, mock_service_class, valid_event, lambda_context):
        ...
        # Arrange
        mock_service = Mock()
        mock_service.verify_email_with_token.side_effect = EmailVerificationError("Verification failed")
        mock_service_class.return_value = mock_service
