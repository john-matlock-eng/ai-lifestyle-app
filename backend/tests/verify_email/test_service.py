...
class TestEmailVerificationService:
    ...
    def test_verify_email_database_update_fails(
        self, service, mock_cognito_client, mock_repository
    ):
    ...
    def test_resend_verification_email_success(self, service, mock_cognito_client, mock_repository):
        ...
        mock_repository.get_user_by_email.return_value = {"user_id": "user-123", "email": email}
        ...
        mock_repository.record_verification_event.assert_called_once_with(
            "user-123", "verification_code_resent", {"email": email}
        )
