...
from get_user_profile.errors import TokenExpiredError, UnauthorizedError, UserNotFoundError
from get_user_profile.handler import lambda_handler
from get_user_profile.models import UserPreferences, UserProfile
...
class TestGetUserProfileHandler:
    ...
    def test_successful_profile_retrieval(
        self, mock_cognito_class, mock_repo_class, mock_service_class, valid_event, lambda_context
    ):
    ...
    def test_expired_token(
        ...
        mock_service = Mock()
        mock_service_class.return_value = mock_service
        mock_service.get_user_profile.side_effect = TokenExpiredError("Access token has expired")
    ...
    def test_user_not_found(
        ...
        mock_service = Mock()
        mock_service_class.return_value = mock_service
        mock_service.get_user_profile.side_effect = UserNotFoundError("User not found")
