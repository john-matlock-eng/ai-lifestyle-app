...
class TestRegistrationService:
    ...
    def valid_request(self):
        ...
        return RegisterRequest(
            email="test@example.com", password="SecureP@ss123", firstName="John", lastName="Doe"
        )
    ...
    def test_successful_registration(self, registration_service, valid_request):
        ...
        # Verify method calls
        registration_service.user_repository.get_user_by_email.assert_called_once_with(
            valid_request.email
        )
    ...
    def test_rollback_on_dynamodb_create_failure_after_cognito(
        self, registration_service, valid_request
    ):
...
class TestPasswordValidation:
    ...
    def test_valid_password(self):
        ...
        valid_passwords = ["Password123!", "SecureP@ss123", "MyStr0ng!Pass", "Test123$Word"]
